...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Assets/Images.xcassets"
  ...
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Controllers/StreamListController.xib"
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Views/EmptyView.xib"
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Views/HeaderView.xib"
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Views/LandscapeMessageCell.xib"
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Views/NewStreamCell.xib"
  install_resource "${PODS_ROOT}/../../AntViewer_ios/Classes/Views/PollCell.xib"
